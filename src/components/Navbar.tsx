      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="/#about" className="text-gray-600 hover:text-teal-500">
              About
            </a>
            <a
              href="/#mission-vision"
            ...
            <a href="/#roadmap" className="text-gray-600 hover:text-teal-500">
              Roadmap
            </a>
            <a
              href="/#how-to-buy"
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link
                to="/contribute"
                className="block px-3 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600"
              >
                Contribute
              </Link>
            </div>
