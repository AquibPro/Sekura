...
const CountrySelect: React.FC<CountrySelectProps> = ({ value, onChange }) => {
  ...
  return (
    <select
      ...
      className="block w-24 rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500"
